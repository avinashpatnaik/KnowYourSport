...
/**
 * The sports repository which is responsible for getting the data from the API
 */
class SportsDataRepository(mySportsAPI: MySportsAPI) {
    ...
    fun getEventsForLeagueCode(leagueCode: String) {
        val call = mySportsAPI.getPastEventForLeague(leagueCode)!!
